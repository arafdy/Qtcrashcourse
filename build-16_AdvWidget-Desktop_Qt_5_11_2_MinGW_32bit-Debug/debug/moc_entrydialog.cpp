...
#include "../../16_AdvWidget/entrydialog.h"
...
QT_INIT_METAOBJECT const QMetaObject entryDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_entryDialog.data,
      qt_meta_data_entryDialog,  qt_static_metacall, nullptr, nullptr}
};
...
void *entryDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::entryDialog"))
        return static_cast< Ui::entryDialog*>(this);
